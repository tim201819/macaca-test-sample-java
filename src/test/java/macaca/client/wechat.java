...
public class wechat {
    ...
    @Test public void test_case_1() throws Exception {
        ...
        // 鎷栨嫿涓�涓厓绱犳垨鑰呭湪澶氫釜鍧愭爣涔嬮棿绉诲姩,瀹炵幇tableview婊氬姩鎿嶄綔
...
//        switchToWebView(driver).elementById("index-kw").sendKeys("涓枃+TesterHome");

        Element input = switchToWebView(driver).elementById("index-kw");
        input.sendKeys("涓枃+TesterHome");
        driver.sleep(1000);
